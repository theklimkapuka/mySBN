...
def train(args):
    ...
    print('-------------------------------')
    print('Starting to load the test set')
    logger.info('Starting to load the test set')
    ...
    logger.info('Test set loading complete')
    print('-------------------------------')
    ...
    if args.mode == 'train':
        print('-------------------------------')
        logger.info('Starting to load the training and validation sets')
        print('Starting to load the training and validation sets')
        ...
        print('Training and validation sets loading complete')
        logger.info('Training and validation sets loading complete')
        print('-------------------------------')
...
def main():
    ...
    '''Apply attention to similar spans'''
    # Only use the first token of the result in tokenization
    parser.add_argument("--Only_token_head", default=False)
    # Select the synthesis method for the span
    parser.add_argument('--span_generation', type=str, default="CNN", choices=["Start_end", "Max", "Average", "CNN", "ATT"],
    ...
    # Whether to add separation loss to the relevant spans
    ...
    parser.add_argument('--kl_loss_mode', type=str, default="KLLoss", choices=["KLLoss", "JSLoss", "EMLoss, CSLoss"],
                        help='Select the separation function for separating similar spans, KL divergence, JS divergence, Euclidean distance and cosine similarity')
    # Whether to use the filtering algorithm in testing
    parser.add_argument('--Filter_Strategy',  default=True, help='Whether to use a filtering algorithm to remove conflicting triples')
    ...
    # Select the number of ATT blocks in Cross Attention
    ...
    # Sort input according to sentence order
    parser.add_argument("--order_input", default=True, help="")
    '''Randomize input span order'''
    ...
    # Use warm-up for quick convergence
