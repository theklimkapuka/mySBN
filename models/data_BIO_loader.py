    ...
    def __init__(self, sentence_pack, args):
        ...
        for triple in sentence_pack['triples']:
            ...
            for i, object in enumerate(objects):
                # Since each aspect in the dataset's triples has only one instance, 
                # but there may be multiple opinions, it is necessary to construct them separately.
    ...
    for ex_index, example in enumerate(train_instances):
        ...
        for triple_name in sample['triples']:
            ...
            if opinion_span not in opinion_reverse:
                ...
                '''Different opinions of the same aspect have the same polarity, but...'''
        ...
        if differ_opinion_sentiment:
            ...
            print(ex_index, 'Single opinion words can have multiple polarities.')
            continue
        ...
        #     print('Different triples use the same aspect repeatedly:', example.id)
    ...
    for ex_index, line in enumerate(lines):
        ...
        for triple in raw_pairs:
            ...
            if word not in triple_dict:
                ...
                print('Single sentence' + id + 'Duplicate triples detected!')
